...
nvm_err_t storage_read_str(storage_handle_t handle, char *string, size_t maxlen);
nvm_err_t storage_write_str(storage_handle_t handle, const char *string, size_t maxlen);
